...
export default function ApplicationForm() {
  return (
    <PageBox title="TG ECET - 2026 APPLICATION FORM">
      <p className="mb-4">
        <span className="text-red-600 font-bold">NOTE :</span> In case you have not paid the fee yet,
        please visit this page <span className="text-blue-700">(Click Here)</span> and pay the fee first.
      </p>
...
function PageBox({ title, children }: any) {
  return (
    <div className="max-w-7xl mx-auto mt-10 border border-gray-300 bg-[#f8fbf8] min-h-[260px]">
